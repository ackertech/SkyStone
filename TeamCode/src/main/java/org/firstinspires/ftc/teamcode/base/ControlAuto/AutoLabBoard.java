   ...
   public final long sleepTime = 100;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive()) {
            ...
            rookieBoard.driveForward(SPD_DRIVE_MAX);
            sleep(1000);
            ...
            rookieBoard.driveBackward(SPD_DRIVE_MAX);
            sleep(1000);
            ...
            rookieBoard.rotateLeft(SPD_DRIVE_MAX);
            sleep(1000);
            ...
            rookieBoard.rotateRight(SPD_DRIVE_MAX);
            sleep(1000);
